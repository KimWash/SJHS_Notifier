...
import java.lang.Exception
 ...
 class editTableActivity : AppCompatActivity()  {
    ...
    var period:Int? = null
     ...
     private lateinit var sPeriodSpinner: Spinner
     private lateinit var ePeriodSpinner: Spinner
    ...
    fun uiStartUp(): Int{
        try{
            ...
            sPeriodSpinner = findViewById(R.id.sPeriodSpinner)
            ePeriodSpinner = findViewById(R.id.ePeriodSpinner)
